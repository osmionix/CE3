...
for ii = 1:length(EbN0dB)
    ...
    % Taking FFT, the term (nFFT/sqrt(nDSC)) is for normalizing the power of the transmit symbol to 1
    ...
    % Adding noise, the term sqrt(80/64) accounts for the wasted energy due to cyclic prefix
    ...
    % Extracting modulated data subcarriers
